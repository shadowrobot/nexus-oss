...
Ext.define('NX.coreui.app.PluginStrings', {
  ...
  keys: {
    ...
    HealthCheckSearch_Versions_Popular: 'Most popular version',
    SearchResultAssetList_Name_Header: 'Name',
    HealthCheckSearch_Age_Header: 'Age',
    HealthCheckSearch_Popularity_Header: 'Popularity',
    ...
    // Browse -> Feeds
    Feeds_Text: 'Feeds',
    Feeds_Description: 'Browse and subscribe to system events',
    Feed_FeedFeature_Subscribe_Button: 'Subscribe',
    Feed_FeedList_Feed_Header: 'Feed',
    Feed_FeedList_URL_Header: 'URL',
    Feed_FeedList_Filter_EmptyText: 'No feeds matched "$filter"',
    ...
    FeatureGroups_Upload_Description: 'Upload content to Nexus',
    ...
    Repository_Facet_NegativeCacheFacet_QueryCacheSize_HelpText: 'Maximum number of cached query results',
    Repository_Facet_NugetProxyFacet_ItemMaxAge_FieldLabel: 'Query cache age',
    Repository_Facet_NugetProxyFacet_ItemMaxAge_HelpText: 'How long to cache query results (in seconds)',
    ...
    Blobstores_Text: 'Blobstores',
    Blobstores_Description: 'Manage blobstores',
    Blobstores_Create_Title: 'Create blobstore',
    Blobstore_BlobstoreAdd_Create_Success: 'Blobstore created: ',
    Blobstore_BlobstoreAdd_Create_Error: 'You do not have permission to create blobstores',
    Blobstore_BlobstoreSettingsForm_Update_Success: 'Blobstore updated: ',
    Blobstore_BlobstoreSettingsForm_Update_Error: 'Update is not supported for blobstores',
    Blobstore_BlobstoreList_New_Button: 'Create blobstore',
    ...
    Blobstore_BlobstoreList_Filter_EmptyText: 'No blobstores matched "$filter"',
    Blobstore_BlobstoreList_EmptyText: 'No blobstores defined',
    Blobstore_BlobstoreFeature_Delete_Button: 'Delete blobstore',
    ...
    User_UserSettingsExternalForm_ExternalRoles_HelpText: 'These roles cannot be changed from within Nexus',
    ...
    Ldap_LdapServerUserAndGroupMappingTestResults_Close_Button: 'Close',
    ...
    SslCertificates_Description: 'Manage trusted SSL certificates for use with the Nexus trust store',
    ...
    SslCertificates_Remove_Button: 'Remove certificate from trust store',
    SslCertificates_Add_Button: 'Add Certificate to trust store',
    ...
    Analytics_AnalyticsEventList_Timestamp_Header: 'Timestamp (ms)',
    Analytics_AnalyticsEventList_Sequence_Header: 'Sequence',
    Analytics_AnalyticsEventList_Duration_Header: 'Duration (ns)',
    ...
    System_HttpSettings_ExcludeHosts_HelpText: 'Java system property http.nonProxyHosts glob-like patterns are supported (one per line, no \'|\' hostname delimiters)',
    ...
    Tasks_Select_Title: 'Select a Service Type',
    Task_TaskSelectType_Filter_EmptyText: 'No service types matched "$filter"',
    Task_TaskSelectType_Name_Header: 'Service type',
