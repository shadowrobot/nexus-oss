    ...
    extends CollectionEntityAdapter<T>
{
  ...
  protected void defineType(final OClass type) {
    type.createProperty(P_BUCKET, OType.LINK, bucketEntityAdapter.getType()).setMandatory(true).setNotNull(true);
  ...
  protected void readFields(final ODocument document, final T entity) {
    ...
    entity.bucketId(bucketEntityAdapter.encode(bucketId));
